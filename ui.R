    ...
    tabPanel("Specify",
        fluidRow(
            column(6,
                ...
                uiOutput('getFormula'),
                actionButton('psButton', "I have finished typing"),
            ...
            column(6,
                ...
                tags$br(),
                tags$hr(),
                actionButton('selVarsButton', "I have finished choosing variables"),
                textOutput('selVarsNeedCheckingText'),
                tags$head(tags$style(
                    "#selVarsNeedCheckingText{color: red; font-size: 10px; }" )),
                tags$hr(),
