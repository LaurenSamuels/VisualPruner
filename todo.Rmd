...
Note that for histograms, we do not want to show the imputed values.
Do print N missing for histograms.
Pruning is then more complicated: prune on "missing or between X and Y" or missing v not missing, etc.
